function save_four_in_row_with_cbar4(imgA, imgB, imgC, imgD, outpdf, span, opts)
    ...
    placePanel(2, IB, '(b)', '$0.4\tau_{gate}$');
    placePanel(3, IC, '(c)', '$0.6\tau_{gate}$');
    placePanel(4, ID, '(d)', '$\tau_{gate}$');
